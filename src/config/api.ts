import { IBackendRes, ICompany, IAccount, IUser, IModelPaginate, IGetAccount, IJob, IResume, IPermission, IRole, ISkill, ISubscribers, IUserUpdate, IChangePassword } from '@/types/backend';
...
export const callChangePassword = (currentPass:string,newPass:string) => {
    return axios.post<IBackendRes<string>>('/api/v1/auth/change-password',{currentPass,newPass})
}
